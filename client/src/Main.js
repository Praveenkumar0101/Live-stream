...
function Stream() {
  ...
  const [profilePicUrl, setProfilePicUrl] = useState(""); // Store the uploaded profile picture URL
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setProfilePicUrl(response.data.profilePictureUrl); // Update profile picture URL in the state
